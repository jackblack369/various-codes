...
class PluginWebservicesMethodCommon {
    ...
    * @param $code interger : value of the error code
    * @param $code string : desciption of the error
    *
   ...
   static function getDisplayError() {
      ...
      if (isset($_SESSION["MESSAGE_AFTER_REDIRECT"])
         ...
         $msg = html_clean($_SESSION["MESSAGE_AFTER_REDIRECT"]);
    ...
    *
    * @return array (of false if unknown name)
    */
   ...
   static function methodListDropdownValues($params, $protocol) {
      ...
      if (isset($params['helpdesk'])
         && $params['helpdesk']
         && FieldExists($table, 'is_helpdeskvisible')) {
         $query .= " AND `is_helpdeskvisible`='1'";
      }
