Exemple 7.18 : SignatureTest.java

import java.io.*;
import java.security.*;

/**
   Ce programme montre comment signer un message avec une clé
   DSA privée et le vérifier avec la clé publique correspondante.
   Utilisation :
