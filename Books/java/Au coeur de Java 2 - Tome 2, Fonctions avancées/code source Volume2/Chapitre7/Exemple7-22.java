...
/**
   ...
   java RSATest -genkey public privé
   java RSATest -encrypt public crypté en texte brut
   java RSATest -decrypt privé crypté et décrypté
*/
public class RSATest
{
   public static void main(String[] args)
   {
      try
      {
         ...
         else
         {
            ...
            // déballe avec la clé privée RSA
            ObjectInputStream keyIn = new ObjectInputStream(
               new FileInputStream(args[3]));
   ...
   /**
      ...
      d'entrée et envoie les octets transformés à un flux de sortie.
