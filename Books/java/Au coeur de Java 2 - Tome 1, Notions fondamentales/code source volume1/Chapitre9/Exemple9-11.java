...
{  
   ...
   {  
      ...
      // démonstration de caractères mnémoniques
      ...
      // ajout possible du caractère mnémonique à une action
      Action aboutAction = new TestAction("About");
      aboutAction.putValue(Action.MNEMONIC_KEY, 
         new Integer('A'));
      helpMenu.add(aboutAction);

      // ajouter tous les menus principaux à la barre de menus
      ...
      // démonstration de menu contextuel 
...
/**
   Un exemple d'action qui affiche le nom de l'action dans System.out
*/
