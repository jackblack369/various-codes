...
<table width="500" border="0" cellspacing="2" cellpadding="2" align=center>
  <tr>
    ...
    <td><?php echo $list[0]->login;?></td>
  </tr>
  <tr>
    <td align=right>Mot de Passe : </td>
    <td>
<?php for ($i=0;$i<strlen($list[0]->password);$i++) 
{
	echo "*";
}
?>
    ...
    <td>Email : </td>
    <td><input name="email" type="text" value="<?php echo stripslashes($list[0]->email) ?>">
  ...
  <tr> 
    ...
    <select name="niveau" > 
    <?php
    echo ligne_selected('Utilisateur','user',$list[0]->niveau);
    echo ligne_selected('Administrateur','admin',$list[0]->niveau);
	?>        
